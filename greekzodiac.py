...
def custom_rot_cipher(input_str, shift, mode, null_symbol=None):
    # English alphabet + Zodiac symbols + Greek symbols
    custom_alphabet = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ♈♉♊♋♌♍♎♏♐♑♒♓ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩ'
    result = ''
...
def main():
    parser = argparse.ArgumentParser(description='Custom ROT cipher with Zodiac and Greek symbols.')
